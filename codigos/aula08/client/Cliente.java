...
public class Cliente extends javax.swing.JFrame {
    ...
    private void txtEntradaKeyPressed(java.awt.event.KeyEvent evt) {
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) { // se apertou a tecla ENTER
            Mensagem msg = new Mensagem(nomeUsuario, txtEntrada.getText(), sala);
            try {
                out.writeObject(msg);
                txtEntrada.setText("");
            } catch (Exception e) {
    ...
    private void btnConectarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        nomeUsuario = txtUsuario.getText().split("/")[0].trim();
        sala = txtUsuario.getText().split("/")[1].trim();

        try {
            socket = new Socket(ip, porta);
            escuta = new Escuta(socket, txtHistorico, sala);
            escuta.start();
